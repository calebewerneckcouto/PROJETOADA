...
public class ProdutoService {
    ...
    public Produto cadastrarProduto(String nome, String descricao, double preco, int quantidadeEstoque) {
        ...
        if (preco <= 0) throw new ValidationException("Preço deve ser maior que zero");
        if (quantidadeEstoque < 0) throw new ValidationException("Quantidade em estoque não pode ser negativa");
    ...
    public Produto atualizarProduto(Long id, String nome, String descricao, double preco, Integer quantidadeEstoque) {
        ...
        if (nome != null && !nome.trim().isEmpty()) produto.setNome(nome);
