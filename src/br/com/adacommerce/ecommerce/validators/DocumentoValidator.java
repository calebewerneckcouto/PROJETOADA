    ...
    public static void validar(String documento) {
        ...
        if (documentoLimpo.length() == 11) {
            if (!validarCPF(documentoLimpo)) {
                throw new ValidationException("CPF inválido: " + documento);
            }
        }
      
        else if (documentoLimpo.length() == 14) {
            if (!validarCNPJ(documentoLimpo)) {
                throw new ValidationException("CNPJ inválido: " + documento);
            }
        } else {
            throw new ValidationException("Documento inválido: " + documento);
        }
    }
